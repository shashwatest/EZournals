...
export default function SignupScreen({ navigation }) {
  ...
  const validate = () => {
    ...
    else if (!validatePassword(password)) e.password = 'Password must be at least 6 characters';
  ...
  return (
    <View style={[styles.container, { backgroundColor: theme.background }]}>
      ...
      <ScrollView contentContainerStyle={styles.scrollContent} keyboardShouldPersistTaps="handled">
        ...
        <Text style={[styles.subtitle, { color: theme.textSecondary }]}>Start your journaling journey today</Text>

        {/* Name */}
        <View style={styles.fieldGroup}>
          <Text style={[styles.label, { color: theme.textSecondary }]}>Name</Text>
          <View style={[styles.inputRow, { borderColor: errors.name ? theme.danger : theme.border, backgroundColor: theme.surface }]}>
          ...
          {errors.name ? <Text style={[styles.fieldError, { color: theme.danger }]}>{errors.name}</Text> : null}
        </View>
        ...
        <View style={styles.fieldGroup}>
          ...
          <View style={[styles.inputRow, { borderColor: errors.confirmPassword ? theme.danger : theme.border, backgroundColor: theme.surface }]}>
            <Ionicons name="lock-closed-outline" size={18} color={theme.textSecondary} />
            <TextInput
              style={[styles.inputInner, { color: theme.text }]}
          ...
          {errors.confirmPassword ? <Text style={[styles.fieldError, { color: theme.danger }]}>{errors.confirmPassword}</Text> : null}
        </View>
